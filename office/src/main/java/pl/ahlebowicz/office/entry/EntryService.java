...
public class EntryService {
    ...
    public Entry acceptEntry(Long regattaId, String sailNumber) {
        ...
        if (entryRepository.existsByRegattaIdAndSailNumber(regattaId, sailNumber)) {
            throw new ConflictException("Numer na żaglu " + sailNumber + " jest już zgłoszony w tych regatach");
        }
        ...
        outboxWriter.write(OfficeTopics.OFFICE_EVENTS, regattaId, toEvent(accepted));
